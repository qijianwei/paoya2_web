...
declare namespace wx {
  ...
  export function shareAppMessage(obj: _shareAppMessageObject)
  export function getUpdateManager()
  export function onShow(cb: Function)
  export function onHide(cb: Function)
  ...
  export function onAudioInterruptionEnd(func)
